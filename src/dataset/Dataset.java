...
public interface Dataset extends List<Instance> {
    ...
    /**
     * Get the array of values of the feature with a certain index.
     *
     * @param pos
     *            the position of the feature you want to retrieve.
     * @return an array of values of the certain feature
     */
    public double[] getFeature(int pos);

    /**
     * The number of features in all instances in data set.
    ...
    /**
     * Returns the index of the class value of the supplied instance. This
